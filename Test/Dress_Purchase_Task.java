...
public class Dress_Purchase_Task {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		// Login Page
		driver.findElement(By.xpath("//a[@class='login']")).click(); // sign in
		driver.findElement(By.id("email")).sendKeys("jayanthikumaran003@gmail.com"); // email id
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("Lakshi123"); // password
		// scroll down
		...
		File to = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap.png");
		org.openqa.selenium.io.FileHandler.copy(from, to);
		driver.manage().timeouts().implicitlyWait(10000, TimeUnit.MILLISECONDS);

		WebElement login = driver
				.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div/div/div[2]/form/div/p[2]/button/span"));
		login.click();
		...
		File to1 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap1.png");
		org.openqa.selenium.io.FileHandler.copy(from1, to1);
		...
		File to2 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap2.png");
		org.openqa.selenium.io.FileHandler.copy(from2, to2);

		Thread.sleep(3000);

		WebElement counts = driver.findElement(
				By.xpath("/html/body/div/div[2]/div/div[3]/div/div/div/div[4]/form/div/div[2]/p[1]/a[2]/span"));
		...
		File to3 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap3.png");
		org.openqa.selenium.io.FileHandler.copy(from3, to3);
		...
		File to4 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap4.png");
		org.openqa.selenium.io.FileHandler.copy(from4, to4);
		...
		File to5 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap5.png");
		org.openqa.selenium.io.FileHandler.copy(from5, to5);
		...
		File to6 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap6.png");
		org.openqa.selenium.io.FileHandler.copy(from6, to6);
		Thread.sleep(2000);
		...
		File to7 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap7.png");
		org.openqa.selenium.io.FileHandler.copy(from7, to7);
		...
		File to8 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap8.png");
		org.openqa.selenium.io.FileHandler.copy(from8, to8);
		...
		File to9 = new File("C:\\Users\\kumar\\eclipse-workspace\\SeleniumPro\\Screenshot\\snap9.png");
		org.openqa.selenium.io.FileHandler.copy(from9, to9);
